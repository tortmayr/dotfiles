# Generated by Powerlevel10k configuration wizard on 2026-02-13 at 11:22 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    # =========================[ Line #1 ]=========================
    # Right segments moved to line #2 (the prompt_char/cursor line) so the
    # first prompt line is content-width instead of full-width. A full-width
    # first line wraps on every horizontal shrink and gets mangled by herdr's
    # primary-screen reflow. See p10k "Horrific mess when resizing" mitigation.
    newline
    # =========================[ Line #2 ]=========================
    ...
    # time                  # current time
    # ----- (newline relocated to the top of this array; see note above) -----
    # ip                    # ip address and bandwidth usage for a specified network interface
    # public_ip             # public IP address
    # proxy                 # system-wide http/https/ftp proxy
    # battery               # internal battery
    # wifi                  # wifi speed
    # ssexample               # example user-defined segment (see prompt_example function below)
  )
